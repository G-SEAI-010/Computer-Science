...
In this exercise, you will practice conditionals and loops. Follow the instructions step by step and test your code.
...
9.  **Loop with Else Clause**
    ...
    Use a `for` loop to search for a specific value in a list. If the value is found, print a success message and break out of the loop. Otherwise, after the loop finishes, use an `else` clause to print that the value was not found.
...
11.  **Pattern matching**
    ...
    *   Create a three lists: fruits, veggies, meat

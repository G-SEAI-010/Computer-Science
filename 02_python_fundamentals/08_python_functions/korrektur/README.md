...
**In this exercise set, you will practice creating simple Python functions that incorporate conditionals, loops, and basic logic.** Follow the instructions step by step and test your code.

You can complete these exercises using the online editor or by downloading the script and working locally.
